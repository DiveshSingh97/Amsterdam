export const DAYS = [
  {
    ...
    activities: [
      ...
      { icon: '🚢', time: 'Evening opt.', title: 'Optional: Evening Canal Cruise (~€18–25 pp / ≈R342–475)', detail: 'Great city intro. Departs from Central Station or Rembrandtplein.', booking: 'soon', bookingText: 'Book online same day', bookingUrl: 'https://www.stromma.com/en-nl/amsterdam/sightseeing/canal-tours/', bookingNote: 'Book online — evening slots fill up in April.' },
      { icon: '🃏', time: 'Pro tip', title: 'Amsterdam City Card — worth it?', detail: 'Covers Rijksmuseum + Van Gogh + unlimited GVB trams/metro/buses. 3-day card from €85 (≈R1,615). If you\'re doing both museums + multiple tram days, it pays for itself.', booking: 'soon', bookingText: 'Buy online before you arrive', bookingUrl: 'https://www.iamsterdam.com/en/tickets/i-amsterdam-city-card', bookingNote: 'Covers Rijksmuseum + Van Gogh + unlimited GVB transport. 3-day card from €85 (≈R1,615).' },
    ],
    extras: [
